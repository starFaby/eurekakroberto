...
class Proforma(db.Model):
    ...
    pfsabpfcreatedat = db.Column(db.String(11), nullable=True) 
    ...
    def __init__(self, pfsabpfnumpf, pfsabpfsubtotal, pfsabpfdto, pfsabpfiva, pfsabpftotal, pfsabpfestado, pfsabpfcreatedat):
...
class ProformaSchema(ma.Schema):
    class Meta:
        fields = ('pfsabpfid', 'pfsabpfnumpf', 'pfsabpfsubtotal', 'pfsabpfdto', 'pfsabpfiva', 'pfsabpftotal', 'pfsabpfestado', 'pfsabpfcreatedat')
...
class Detalleproforma(db.Model):
    ...
    def __init__(self, pfsabdpcantidad, pfsabdprecio, pfsabdptotal, pfsabdpestado, pfsabdpcreatedat):
...
class DetalleproformaSchema(ma.Schema):
    class Meta:
        fields = ('pfsabdpid', 'pfsabdpcantidad', 'pfsabdprecio', 'pfsabdptotal', 'pfsabdpestado', 'pfsabdpcreatedat')
